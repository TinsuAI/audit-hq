...
| **C1.3** | Có trong M15 nhưng không có tờ khai — `nhập_trong_kỳ` > 0 mà không có tờ khai tương ứng. Rủi ro: M15 không có căn cứ tờ khai; doanh nghiệp có thể "mượn" mã nguyên vật liệu nhập khẩu để hợp thức hoá hàng mua nội địa không hoá đơn hoặc hàng nhập khẩu không khai báo, đưa vào phạm vi miễn thuế. | 🔴 | ✅ |
...
| **C2.3** | Tồn cuối âm — nguyên vật liệu (M15) — `tồn_cuối_kỳ` < 0 trên bất kỳ mã nào. Rủi ro: Khả năng bỏ sót tờ khai nhập khẩu, sử dụng nguyên vật liệu không khai báo, hoặc điều chỉnh số liệu tồn kho không đúng thực tế. | 🔴 | ✅ |
| **C2.4** | Tồn cuối âm — thành phẩm (M15a) — `tồn_cuối_kỳ` < 0 trên bất kỳ mã nào. Rủi ro: Tương tự C2.3 cho thành phẩm — bỏ sót tờ khai, sử dụng hàng không khai báo, hoặc điều chỉnh số liệu tồn kho sai thực tế. | 🔴 | 🚧 |
| **C2.5** | Tồn cuối lớn hơn nhập khi tồn đầu bằng 0 — `tồn_đầu_kỳ` = 0 nhưng `tồn_cuối_kỳ` > `nhập_trong_kỳ`. Rủi ro: "Tồn kho ảo" để treo nợ thuế — doanh nghiệp thực tế đã tiêu thụ hàng nhưng trên báo cáo vẫn thể hiện tồn kho lớn để không phải nộp thuế nhập khẩu. | 🔴 | 🚧 |
...
| **C5.2** | Thành phẩm xuất khẩu không có trong M16 (thành phẩm "mồ côi") — mã thành phẩm có `xuất_khẩu` > 0 trong M15a nhưng không có dòng M16. Rủi ro: Không thể giải trình nguyên vật liệu đầu vào cho thành phẩm đã xuất khẩu; doanh nghiệp có thể dùng nguyên liệu không rõ nguồn gốc (kể cả hàng lậu) để sản xuất xuất khẩu. | 🟡 | 🚧 |
...
| **C6.4** | Nhập tăng mạnh nhưng xuất khẩu không tăng tương ứng — `nhập_trong_kỳ` tăng >X% trong khi `xuất_khẩu` tăng <Y%. Ngưỡng: nhập tăng >50% trong khi xuất tăng <10% Cảnh báo. Rủi ro: Tích luỹ tồn nguyên vật liệu bất thường, nguy cơ chuyển nội địa không khai báo A42. **Cảnh báo đặc biệt:** doanh nghiệp sắp giải thể, bỏ trốn — tranh thủ nhập lượng lớn hàng miễn thuế rồi tẩu tán ra thị trường trước khi đóng mã số thuế. | 🟡 | 🚧 |
...
| Mã | Tên | Mức | Trạng thái |
|---|---|---|---|
| **C8.1** | Tỷ lệ phế liệu / phế phẩm thực tế vượt ngưỡng ngành — cặp NVL-thành phẩm có tỷ lệ phế thải cao bất thường so với mặt bằng ngành. Rủi ro: Khai phế liệu cao để giảm lượng NVL cần giải trình hoặc che tiêu thụ nội địa. | 🟡 | ⏳ |
| **C8.2** | Phế liệu bán nội địa không có tờ khai chuyển mục đích sử dụng (A42) — doanh nghiệp ghi nhận bán phế liệu trong sổ sách nhưng không có A42 tương ứng. Rủi ro: Vi phạm điều kiện miễn thuế — phế liệu phát sinh từ NVL miễn thuế, bán nội địa phải khai A42 và nộp thuế. | 🔴 | ⏳ |
| **C8.3** | Tỷ lệ phế liệu thay đổi đột biến giữa các kỳ — tỷ lệ phế thải kỳ N cao bất thường so với kỳ N-1 (cùng dây chuyền sản xuất). Rủi ro: Điều tiết phế liệu để cân đối số liệu tồn kho qua các kỳ. | 🟡 | ⏳ |
...
| Mã | Tên | Mức | Trạng thái |
|---|---|---|---|
| **C9.1** | BTP đa tầng không truy nguồn được về NVL gốc — BTP cấp 1, 2, 3... không có liên kết về nguyên vật liệu ban đầu. Rủi ro: Làm mờ truy nguồn — NVL đã nhập khẩu "nằm" trong BTP nhiều tầng, đối chiếu với thành phẩm xuất khẩu không còn tuyến tính. | 🟡 | ⏳ |
| **C9.2** | Tồn BTP cuối kỳ N khác tồn BTP đầu kỳ N+1 — biến động không có giải trình. Rủi ro: BTP bị "đẩy qua lại" giữa các kỳ để điều chỉnh tồn kho mà không thay đổi dòng thực tế. | 🟡 | ⏳ |
| **C9.3** | Tồn BTP lớn không tương xứng với năng lực sản xuất khai báo — số lượng BTP tồn vượt xa năng lực dây chuyền. Rủi ro: Che giấu tiêu thụ nội địa — NVL đã đưa vào BTP nhưng thực tế bị tiêu thụ / bán nội địa, khó phát hiện vì chưa "ra thành phẩm". | 🟡 | ⏳ |
| **C9.4** | Cấu thành NVL của BTP không khớp giữa định mức khai báo và sổ kho thực tế — định mức tầng BTP tính ra khác lượng NVL đã xuất kho cho BTP đó. Rủi ro: Tách nhỏ một quy trình sản xuất thành nhiều tầng BTP để làm loãng sai lệch định mức, tạo vùng xám dễ lợi dụng. | 🔴 | ⏳ |
...
| Mã | Tên | Mức | Trạng thái |
|---|---|---|---|
| **C10.1** | Tồn kho đầu/cuối kỳ BCQT khác số dư các tài khoản 152, 155, 156 trên Bảng cân đối phát sinh. Rủi ro: Số liệu BCQT không khớp sổ sách kế toán — hai nguồn số liệu mâu thuẫn cần làm rõ. | 🔴 | ⏳ |
| **C10.2** | Doanh thu xuất khẩu sổ sách kế toán khác trị giá xuất khẩu BCCT. Rủi ro: Khai sai một trong hai phía, ảnh hưởng nghĩa vụ thuế. | 🟡🔴 | ⏳ |
| **C10.3** | Giá trị nhập khẩu sổ sách kế toán khác trị giá nhập khẩu BCCT. Rủi ro: Khai sai một trong hai phía hoặc có nguồn nhập không khai báo. | 🟡🔴 | ⏳ |
...
| Mã | Tên | Mức | Trạng thái |
|---|---|---|---|
| **C11.1** | Máy móc thiết bị miễn thuế nhập khẩu (E13) không khớp danh mục thiết bị trong báo cáo cơ sở sản xuất. Rủi ro: Máy móc miễn thuế đã bán nội địa, chuyển nhượng, hoặc đưa ra khỏi cơ sở mà không khai báo. | 🔴 | ⏳ |
| **C11.2** | Công suất máy móc khai báo không khớp sản lượng thực tế trong BCQT — sản lượng vượt hoặc thấp xa năng lực thiết bị khai báo. Rủi ro: Khai báo công suất không trung thực để được miễn thuế / để hợp thức hoá lượng xuất khẩu. | 🟡 | ⏳ |
...
> **Đây là bản dự thảo lần 5.** Mọi nội dung là đề xuất sơ bộ và sẽ được điều chỉnh theo phản hồi của cơ quan Hải quan qua các vòng tổng hợp tiếp theo.
